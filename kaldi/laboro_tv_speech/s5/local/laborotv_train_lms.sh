...
ngram-count -text $dir/train.gz -order 3 -limit-vocab -vocab $dir/wordlist \
  -unk -map-unk "<unk>" -kndiscount -interpolate -lm $dir/laborotv.o3g.kn.gz
echo "PPL for LM:"
ngram -unk -lm $dir/laborotv.o3g.kn.gz -ppl $dir/heldout
ngram -unk -lm $dir/laborotv.o3g.kn.gz -ppl $dir/heldout -debug 2 >&$dir/ppl2
